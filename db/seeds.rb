...
demands = [
  ...
  # debut vendée
  {
    first_name: "Fabrice",
    last_name: "Dupont",
    address: "3 Rue Charles Milcendeau",
    city: "Soullans",
    zipcode: "85300",
    illness: "Infection pulmonaire",
    phone: "+33 1 3456 6543",
...

  {
    first_name: "Martin",
    last_name: "Longeot",
    address: "2 Impasse Georges Clemenceau",
    city: "Coëx",
    zipcode: "85220",
    illness: "Etat grippal",
...

  {
    first_name: "Lucie",
    last_name: "Patet",
    address: "61 Rue des Pièces Franches",
    city: "Olonne-sur-Mer",
    zipcode: "85340",
    illness: "Toux sèche",
...

  {
    first_name: "Marguerite",
    last_name: "Danet",
    address: "13 rue du point du jour",
    city: "Saint-Révérend",
    zipcode: "85220",
    illness: "Gastro",
...

  {
    first_name: "Brigitte",
    last_name: "Ladanette",
    address: "61 rue Georges Clemenceau",
